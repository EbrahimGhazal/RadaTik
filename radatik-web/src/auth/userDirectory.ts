...
const LOGIN_EMAIL_ALIASES: Record<string, string> = {
  admin: 'admin@radatik.dev',
  administrator: 'admin@radatik.dev',
  ops: 'ops@radatik.dev',
  manager: 'manager@radatik.dev',
  client: 'client@radatik.dev',
  cash: 'cash@radatik.dev',
}
