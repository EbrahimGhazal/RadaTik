...
namespace RadaTik.Models
{
    ...
    public class Profile
    {
        ...
        [Display(Name = "كتالوج الشركة")]
        public int? CompanyProfileCatalogId { get; set; }

        [ForeignKey(nameof(CompanyProfileCatalogId))]
        public virtual CompanyProfileCatalog? CompanyProfileCatalog { get; set; }
