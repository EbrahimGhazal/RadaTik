...
namespace RadaTik.Models
{
    ...
    public static class MaintenanceCatalog
    {
        ...
        public static readonly MaintenanceType[] SolutionTypes = Domain.Maintenance.MaintenanceSolutionTypes.Values;
        ...
        public static bool IsSolutionType(MaintenanceType type) =>
            Domain.Maintenance.MaintenanceSolutionTypes.Contains(type);

        public static int GetOrder(MaintenanceType type)
        {
            int index = Array.IndexOf(DisplayOrder, type);
