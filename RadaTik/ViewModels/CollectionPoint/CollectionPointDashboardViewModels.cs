...
namespace RadaTik.ViewModels.CollectionPoint
{
    public class CollectionPointDashboardViewModel
    {
        ...
        public List<RadaTik.Models.Network>? AvailableNetworks { get; set; }
    ...
    public class ClientSearchResultItem
    {
        ...
        public decimal TotalAmountDuePointChargeSyp { get; set; }
    ...
    public class ClientDetailsForCollectionPointViewModel
    {
        ...
        /// <summary>المبلغ المستحق بعملة الحساب (شهر واحد أو أكثر عند التجديد).</summary>
        public decimal AmountDueAccount { get; set; }
        /// <summary>ما يُخصم من نقطة التحصيل بالليرة.</summary>
        public decimal AmountDuePointChargeSyp { get; set; }
        public int PendingRenewalMonths { get; set; } = 1;
        public int NetworkId { get; set; }
        public string? NetworkName { get; set; }
        public string? CompanyName { get; set; }
    ...
    public class ReceivePaymentViewModel
    {
        ...
        [Display(Name = "سعر الصرف (1$ = ل.س.ج)")]
        public decimal? ExchangeRate { get; set; }

        [Required(ErrorMessage = "المبلغ مطلوب")]
        [Display(Name = "المبلغ المستلم (ل.س.ج)")]
