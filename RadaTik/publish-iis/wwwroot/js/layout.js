...
(function() {
    ...
    const LayoutManager = {
        ...
        setupMobileMenu: function() {
            ...
            const isMobileSidebar = () => window.innerWidth <= MOBILE_MAX;
            ...
            const ensureBackdrop = () => {
                ...
                if (!backdrop) {
                    ...
                    backdrop.addEventListener('click', () => self.setMobileSidebarOpen(false));
                }
                return backdrop;
            };

            this.setMobileSidebarOpen = (open) => {
                if (!sidebar) return;
                ...
                if (open && isMobileSidebar()) {
                    requestAnimationFrame(() => {
                        const active = sidebar.querySelector('.nav-link.active, .nav-link-sub.active');
            ...
            if (sidebarToggle && sidebar) {
                sidebarToggle.addEventListener('click', (e) => {
                    e.preventDefault();
                    if (isMobileSidebar()) {
                        this.setMobileSidebarOpen(!sidebar.classList.contains('active'));
                    } else {
                ...
                sidebar.querySelectorAll('a.nav-link, a.nav-link-sub').forEach((link) => {
                    link.addEventListener('click', () => {
                        if (isMobileSidebar()) this.setMobileSidebarOpen(false);
                    });
                });
        ...
        setupNavDropdowns: function() {
            document.querySelectorAll('.nav-item.has-dropdown').forEach(function(item) {
                ...
                toggle.addEventListener('click', function(e) {
                    ...
                    if (collapsed && window.innerWidth > 992) return;
        ...
        setupSectionDropdowns: function() {
            ...
            document.querySelectorAll('.nav-section').forEach(function(section) {
                if (section.classList.contains('nav-section-quick')) return;
                ...
                const doToggle = (e) => {
                    ...
                    if (isSingleOpenMode && willOpen) {
                        document.querySelectorAll('.nav-section').forEach((otherSection) => {
                            ...
                            if (otherSection.classList.contains('nav-section-quick')) return;
                            if (otherSection.classList.contains('nav-section-home')) return;
                            if (otherSection.classList.contains('nav-section-account')) return;
            ...
            // الرئيسية وحسابي: يبقيان ظاهرين دائماً
            document.querySelectorAll('.nav-section-quick, .nav-section-home, .nav-section-account').forEach(function(quickSection) {
                quickSection.classList.remove('section-collapsed');
            });
        },
