...
(function() {
    ...
    const CommonUtils = {
        ...
        formatNumber: function(number, decimals = 2) {
            ...
            if (window.SypGlobal && window.SypGlobal.formatWithCommas) {
                return window.SypGlobal.formatWithCommas(Number(number), decimals);
            }
        ...
        /** أعداد غير مالية (عدد عملاء، منافذ، …) — فواصل من 1,000 فما فوق */
        formatCount: function(number) {
            return CommonUtils.formatNumber(number, 0);
        },
