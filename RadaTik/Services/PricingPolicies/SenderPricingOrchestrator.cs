...
public sealed class ImmediateSenderCreationWorkflowStrategy : ISenderCreationWorkflowStrategy
{
        ...
        CancellationToken ct = default)
    {
        ...
        var amountToCharge = initialPricing == null ? 0m : WalletMath.CeilSyp(initialPricing.AmountSYP);
        ...
        return new SenderCreateOutcome
        {
            ...
            Message = amountToCharge > 0m
                ? $"تم إضافة المرسل بنجاح، وتم خصم قيمة الإضافة الأولى ({amountToCharge:N2} ل.س.ج)."
                : "تم إضافة المرسل بنجاح. لا توجد قيمة إضافة أولى مفعلة حالياً."
        };
    }
}
...
public sealed class SenderPricingOrchestrator : ISenderPricingOrchestrator
{
        ...
        CancellationToken ct = default)
    {
        ...
        var amountToCharge = currentPricing != null
            ? WalletMath.CeilSyp(currentPricing.AmountSYP)
