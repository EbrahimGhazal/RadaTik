...
public sealed class ClientWalletTopUpRequestConfiguration : IEntityTypeConfiguration<ClientWalletTopUpRequest>
{
    public void Configure(EntityTypeBuilder<ClientWalletTopUpRequest> entity)
    {
