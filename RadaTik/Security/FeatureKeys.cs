...
public static class FeatureKeys
{
    ...
    /// <summary>مستودع الشركة — أصناف وحركات جرد (منفصل عن المحفظة والصندوق).</summary>
    public const string Warehouse = "Warehouse";

    /// <summary>دفتر الإيراد والمصروف — تتبع بسيط للدخل والمصروف اليومي.</summary>
    public const string MoneyDiary = "MoneyDiary";

    /// <summary>رواتب الموظفين — سجل مستقل عن المحاسبة الإلكترونية للنظام.</summary>
    public const string Payroll = "Payroll";

    /// <summary>نظام ERP متكامل — مهام، مكافآت، عملاء/موردين، محاسبة.</summary>
    public const string Erp = "Erp";

    /// <summary>عمولة المنصة عند تغذية محفظة الموظف من محفظة الشركة (ثابت لكل عملية أو نسبة).</summary>
    public const string PayrollWalletTransferCommission = "PayrollWalletTransferCommission";
}
