...
public static class RoleNames
{
    ...
    /// <summary>
    /// مدير الشركة أو مدير النظام — وصول تشغيلي كامل لوحدات الإدارة (الاشتراكات تبقى لمدير الشركة).
    /// </summary>
    public const string NetworkOrSystemAdministrator = "NetworkAdministrator,SystemAdministrator";
}
