...
/// <summary>
/// جهة طلب التغذية: مدير النظام أو مدير الشركة
/// </summary>
...
/// <summary>
/// طلب تغذية رصيد نقطة التحصيل (يقدمه نقطة التحصيل ويوافق عليه مدير النظام أو مدير الشركة).
/// </summary>
...
public class CollectionPointTopUpRequest
{
    ...
    [Required]
    public CollectionPointTopUpTarget RequestTargetType { get; set; } = CollectionPointTopUpTarget.CompanyManager;
